...
func (c *authClient) Register(ctx context.Context, in *RequestRegister, opts ...grpc.CallOption) (*ResponseRegister, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.Ar1an03.protos.proto.v1.Auth/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) Login(ctx context.Context, in *RequestLogin, opts ...grpc.CallOption) (*ResponseLogin, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.Ar1an03.protos.proto.v1.Auth/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) Logout(ctx context.Context, in *RequestLogout, opts ...grpc.CallOption) (*ResponseLogout, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.Ar1an03.protos.proto.v1.Auth/Logout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) IsAdmin(ctx context.Context, in *RequestIsAdmin, opts ...grpc.CallOption) (*ResponseIsAdmin, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.Ar1an03.protos.proto.v1.Auth/IsAdmin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.Ar1an03.protos.proto.v1.Auth/Register",
	}
...
func _Auth_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.Ar1an03.protos.proto.v1.Auth/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Auth_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.Ar1an03.protos.proto.v1.Auth/Logout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Auth_IsAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.Ar1an03.protos.proto.v1.Auth/IsAdmin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.Ar1an03.protos.proto.v1.Auth",
