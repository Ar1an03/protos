...
const (
	UploadService_UploadFile_FullMethodName = "/upload.v1.UploadService/UploadFile"
)
...
func (c *uploadServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[UploadFileRequest, UploadFileResponse], error) {
...
type UploadService_UploadFileClient = grpc.BidiStreamingClient[UploadFileRequest, UploadFileResponse]
...
func (UnimplementedUploadServiceServer) UploadFile(grpc.BidiStreamingServer[UploadFileRequest, UploadFileResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UploadService_UploadFileServer = grpc.BidiStreamingServer[UploadFileRequest, UploadFileResponse]
