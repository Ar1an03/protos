...
const file_upload_v1_upload_proto_rawDesc = "" +
	...
	"\x06offset\x18\x03 \x01(\x03R\x06offset\"\xce\x01\n" +
	...
	"\x15percent_by_total_size\x18\x04 \x01(\x03R\x12percentByTotalSize\x12!\n" +
	"\fcontent_type\x18\x05 \x01(\tR\vcontentTypeR\bfilename2^\n" +
	"\rUploadService\x12M\n" +
	"\n" +
